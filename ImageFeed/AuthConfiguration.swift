...
enum Constants {
    ...
    //     высока вероятность того, что у меня больше нет запросов на старые ключи, поэтому здесь прилагаю новые (старые ключи закомментированы). их можно раскомитить, если на новых тоже запросы закончатся. иначе тест не проходит
